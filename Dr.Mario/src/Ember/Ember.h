...
namespace Ember {
	...
	public:
		...
		void Draw(const FRect& dest, float angle = 0.0f, const SDL_RendererFlip& flip = SDL_FLIP_NONE, const Vec2& rotate_point = { -1, -1});
		void Draw(const FRect& dest, const Rect& src, const SDL_RendererFlip& flip = SDL_FLIP_NONE, float angle = 0.0f, const Vec2& rotate_point = { -1, -1 });
		void Draw(const Rect& dest, float angle = 0.0f, const SDL_RendererFlip& flip = SDL_FLIP_NONE, const IVec2& rotate_point = { -1, -1 });
		void Draw(const Rect& dest, const Rect& src, const SDL_RendererFlip& flip = SDL_FLIP_NONE, float angle = 0.0f, const IVec2& rotate_point = { -1, -1 });
		...
		SDL_Texture* Tex() { return texture; }
	private:
		SDL_Texture* texture;
		rRenderer* renderer;
	};
	...
	public:
		...
		AudioChunk() : m_chunk(nullptr), m_volume(0) { }
	...
	public:
		...
		AudioMusic() : m_music(nullptr), m_volume(0) { }
		void Initialize(const std::string& file_path);
	...
	public:
		...
		Button() : events(nullptr), clicked(false), in(false), position(0, 0, 0, 0) { }
		bool Hover();
